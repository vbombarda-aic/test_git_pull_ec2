...
MERGE INTO
    Experience AS A
USING (
    SELECT DISTINCT "RespondentID", TO_TIMESTAMP("Timestamp", 'YYYY-MM-DD"T"HH24:MI:SS"Z"') AS Timestamp,
            "Survey", "Content",
            CONCAT_WS('_', "RespondentID", TO_TIMESTAMP("Timestamp", 'YYYY-MM-DD"T"HH24:MI:SS"Z"') AT TIME ZONE 'UTC', "Survey", "Content") AS mergeKey
